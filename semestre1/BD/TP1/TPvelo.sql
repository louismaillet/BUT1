...
SELECT TempsRealise
from TEMPS, COUREURS,ETAPES
where COUREURS.nomCoureur == 'JALABERT' and ETAPES.NumEtape == 3

rouver le temps r´ealis´e par les coureurs sous l’encadrement de Manolo SAIZ dans
