...
def copy_partie(partie:dict)->dict:
    ...
    partie_copie={}
    partie_copie["nom_partie"]=partie["nom_partie"]
    partie_copie["duree_totale"]=partie["duree_totale"]
    partie_copie["temps_restant"]=partie["temps_restant"]
    partie_copie["arene"] = arene.copy_arene(partie["arene"])
    return partie_copie